        ...
        <div class="mt-[4rem] ml-[20rem] bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-8 transition-all duration-300 animate-fade-in pt-[3.5rem]">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/3 text-center mb-8 md:mb-0">
                    <img src="" alt="Profile Picture" class="rounded-full w-48 h-48 mx-auto mb-4 border-4 border-green-500 transition-transform duration-300 hover:scale-105">
                    <h1 class="text-2xl font-bold text-green-500 dark:text-white mb-2"></h1>
                    <p class="text-stone-700 font-semibold">Catégorie</p>
                ...
                <div class="md:w-2/3 md:pl-8">
                    <p class="text-gray-700 font-semibold text-2xl dark:text-gray-300 mb-6"> Catégorie</p>
