    <footer class="bg-gradient-to-r from-[#2E3192] to-[#00B4DB] text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="annonces.php" class="hover:text-blue-200">Annonces</a></li>
                        <li><a href="recherche.php" class="hover:text-blue-200">Rechercher</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="hover:text-blue-200">Comment ça marche</a></li>
                        <li><a href="#" class="hover:text-blue-200">Devenir transporteur</a></li>
                        <li><a href="#" class="hover:text-blue-200">Expédier un colis</a></li>
